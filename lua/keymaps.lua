...
--! NOTE: keymaps, somehow, only apply to .lua files
-- integrate a function to split the current window and place the definition buffer on the bottom side
map('n', 'gd', '<cmd>lua vim.lsp.buf.definition()<CR>', { callback = function ()
    print("hello there")
